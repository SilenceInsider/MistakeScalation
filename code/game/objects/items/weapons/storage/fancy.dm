...
/obj/item/weapon/storage/fancy/keybunch
	name = "bunch of keys"
	desc = "Some keys must be here."
...
/obj/item/weapon/storage/fancy/keybunch/usmclt
	startswith = list(
...
/obj/item/weapon/storage/fancy/keybunch/usmcsarge
	startswith = list(
	/obj/item/weapon/key/ussarge,
	/obj/item/weapon/key/usmedic
	)

/obj/item/weapon/storage/fancy/keybunch/bundesmedic
	startswith = list(
	/obj/item/weapon/key/usmedic,
	/obj/item/weapon/key/bundeswehr
	)

/obj/item/weapon/storage/fancy/keybunch/sovcommand
	startswith = list(
...
/obj/item/weapon/storage/fancy/keybunch/sovprapor
	startswith = list(
		/obj/item/weapon/key/sovietmedic,
		/obj/item/weapon/key/sovietprapor,
		/obj/item/weapon/key/sovietcommand
...
/obj/item/weapon/storage/fancy/keybunch/sovsarge
	startswith = list(
		/obj/item/weapon/key/sovietmedic,
		/obj/item/weapon/key/sovietcommand
		)
